        ...
        <script>
            $(window).load(function () {
                ...
                var calendar = $('#calendar').fullCalendar({
					...
					$sql = "select prop.nomepropriedade,prod.nomeprodutor,vt.relatorio, date_part('YEAR',dataproximavisita) as ano,
date_part('MONTH',dataproximavisita) as mes,
date_part('DAY',dataproximavisita) as dia,
 vt.dataproximavisita,
vt.idvisitasupervisor from 
visitasupervisor vt,
propriedade prop,
produtor prod
where
