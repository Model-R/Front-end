	...
	class MyPag extends Paginacao
	{
		function desenhacabeca($row)
		{
			 ...
			 <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Data Parto </th>
                                                <th class="column-title">Número Lactação </th>
                                                <th class="column-title">Sexo. Bezerro </th>';
		...
		function desenha($row){
			...
			$html = '<td class="a-center '.$inativo.'"><input type="checkbox" class="flat" name="id_visitatecnica[]" id="id_visitatecnica" value="'.$row["idvisitatecnica"].'" ></td>
                                    <td class="'.$inativo.'">'.date('d/m/Y',strtotime($row['dataparto'])).'</td>
                                    <td class="'.$inativo.'">'.$row['lacatacao'].'</td>
                                    <td class="'.$inativo.'">'.$row['sexobezerro'].'</td>';
									$html.='
                                    <td class=" last">'.$acoes.'
                                    </td>';
                        ...
                        <div class="x_content">
                            ...
                            <div class="row">
                                ...
                                <div class="item form-group">
										...
										<div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Lactação<span class="required">*</span>
                                            </label>
											<div class="col-md-6 col-sm-6 col-xs-12"><select name="cmboxlactacao" id="cmboxlactacao" class="form-control">
										...
										<div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Sexo Bezerro<span class="required">*</span>
                                            </label>
											<div class="col-md-6 col-sm-6 col-xs-12"><select name="cmboxsexobezerro" id="cmboxsexobezerro" class="form-control">
												<option value="" <?php if ($porte=='') { echo "SELECTED";}?>></option>
												<option value="Grande" <?php if ($porte=='Grande') { echo "SELECTED";}?>>Grande</option>
												<option value="Médio" <?php if ($porte=='Médio') { echo "SELECTED";}?>>Médio</option>
												<option value="Pequeno" <?php if ($porte=='Pequeno') { echo "SELECTED";}?>>Pequeno</option>
