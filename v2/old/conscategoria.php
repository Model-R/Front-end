...
//	  require_once('classes/categoira.class.php');
	...
	class MyPag extends Paginacao
	{
		function desenhacabeca($row)
		{
			 ...
			 <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Resumida </th>
		...
		function desenha($row){
			...
			$html = '<td class="a-center "><input type="checkbox" class="flat" name="id_categoria[]" id="id_categoria" value="'.$row["idcategoria"].'" ></td>
                                    <td class=" ">'.$row['codigo'].'</td>
                                    <td class=" ">'.$row['categoria'].'</td>
                                    <td class=" "><input type="checkbox" class="flat" name="chkboxativo" id="chkboxativo" value="S" '.$resumida.'></td>
                                    <td class=" last"><a href="cadcategoria.php?op=A&id='.$row['idcategoria'].'" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>
                                                    </td>';
...
if ($tipofiltro=='NOME')
{
   $sql.= " and categoria ilike '%".$valorfiltro."%'";	
}
...
<div id="myModal" class="modal fade">
  <div class="modal-dialog"> 
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Consulta Categoria <small>Categorias cadastrados no sistema</small></h2>
                                ...
                                <span class="caret"></span>
										...
										<?php } ?>
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="cadcategoria.php?op=I">Novo</a>
                                            </li>
								...
								<input type="checkbox" class="flat" name="chkboxresumida" id="chkboxresumida" value="S" <?php if ($resumida=='S') {echo 'checked';}?>> Resumida
	...
	function imprimir(tipo)
	{
		...
		if (tipo=='pdf')
		{
			document.getElementById('frm').action='relcategoria.php';
			document.getElementById('frm').submit();
		}
		if (tipo=='xls')
		{
			document.getElementById('frm').action='relcategoriaExcel.php';
			document.getElementById('frm').submit();
		}
	}
