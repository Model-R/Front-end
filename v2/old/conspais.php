...
<?php require_once('classes/conexao.class.php');
	...
	class MyPag extends Paginacao
	{
		...
		function desenha($row){
			$html = '<td class="a-center "><input type="checkbox" class="flat" name="id_pais[]" id="id_pais" value="'.$row["idpais"].'" ></td>
                                    <td class=" ">'.$row['pais'].'</td>
                                    <td class=" last"><a href="cadpais.php?op=A&id='.$row['idpais'].'" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>
                                                    </td>';
...
if ($tipofiltro=='NOME')
{
   $sql.= " and pais ilike '%".$valorfiltro."%'";	
}

if (($ordenapor=='NOME') || ($ordenapor==''))
{
   $sql.= " order by upper(pais)";	
}
...
<div id="myModal" class="modal fade">
  <div class="modal-dialog"> 
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Consulta País <small>Paises cadastrados no sistema</small></h2>
                                ...
                                <span class="caret"></span>
                                        ...
                                        <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="cadpais.php?op=I">Novo</a>
                                            </li>
	...
	function imprimir(tipo)
	{
		...
		if (tipo=='pdf')
		{
			document.getElementById('frm').action='relpais.php';
			document.getElementById('frm').submit();
		}
		if (tipo=='xls')
		{
			document.getElementById('frm').action='relpaisExcel.php';
			document.getElementById('frm').submit();
		}
	}
