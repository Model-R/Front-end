...
if ($op=='A')
{
	$Sindicato->getById($id);

			$idsindicato = 	   	$Sindicato->idsindicato ;//= $row['nomepropriedade'];
		   	$sindicato = $Sindicato->sindicato ;//= $row['inscricaoestadual'];
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Sindicato <small>Cadastro sindicato</small></h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                    <form name='frm' id='frm' action='exec.sindicato.php' method="post" class="form-horizontal form-label-left" novalidate>
										<input id="op" value="<?php echo $op;?>" name="op" type="hidden">
                                        <input id="id" value="<?php echo $id;?>" name="id" type="hidden">
										
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Sindicato <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="edtsindicato" value="<?php echo $sindicato;?>"  name="edtsindicato" class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
...
function enviar()
		{
			if (
			(document.getElementById('edtsindicato').value=='') 
			)
			{
