		...
		function desenhacabeca($row)
		{
			 ...
			 <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Touro </th>
...
$sql="
select * from cobertura c where idpropriedade = ".$idpropriedade." and ano = ".$ano." and numero = ".$numero."
";	
                        ...
                        <div class="x_content">
                            ...
                            <div class="row">
                                ...
                                <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Data Cobertura <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            	<input id="edtdatacobertura" name="edtdatacobertura" value="<?php 
												if (!empty($datacobertura))
												{
												echo date('d/m/Y',strtotime($datacobertura));
												}
												?>" class="date-picker form-control col-md-7 col-xs-12" type="text" >
                                            </div>
                                        </div>
										 <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Touro<span class="required"></span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="edttouro" value="<?php echo $nome;?>" class="form-control col-md-7 col-xs-12" name="edttouro" placeholder=""  type="text">
                                            </div>
                                        </div>
										 <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="edtobservacao" value="<?php echo $nome;?>" class="form-control col-md-7 col-xs-12" name="edtobservacao" placeholder=""  type="text">
                                            </div>
                                        </div>		
...
//				start = now()
	...
	$(document).ready(function () {
                            $('#edtdatacobertura').daterangepicker({
