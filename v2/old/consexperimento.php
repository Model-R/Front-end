	...
	class MyPag extends Paginacao
	{
		function desenhacabeca($row)
		{
			 ...
			 <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Ocorrências </th>
                                                <th class="column-title">Ocorrências OK </th>
		...
		function desenha($row){
			...
			$html = '<td class="a-center "><input type="checkbox" class="flat" name="id_experiment[]" id="id_experiment" value="'.$row["idexperiment"].'" ></td>
                                    ...
                                    <td class=" ">'.$qtd.'</td>
                                    <td class=" ">'.$qtdok.'</td>
                                    <td class=" last"><a href="cadexperimento.php?op=A&tab=2&id='.$row['idexperiment'].'" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
									<a onclick="limparDadosExperimento('.$row['idexperiment'].')" class="btn btn-primary btn-xs"><i class="fa fa-eraser"></i> Limpar Dados</a>';
									if ($qtdok>0)
									{
										$html.='
									<a onclick="modelar('.$row['idexperiment'].')" class="btn btn-success btn-xs"><i class="fa fa-cogs"></i> Modelar</a>
                                                    </td>';
									}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
								...
								<a href="cadexperimento.php?op=I&idproject=<?php echo $idproject;?>"><button type="button" class="btn btn-info">Novo</button></a>
