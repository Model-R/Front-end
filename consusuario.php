	...
	class MyPag extends Paginacao
	{
		...
		function desenha($row){
			...
			$html = '<td class="a-center "><input type="checkbox" class="flat" name="id_usuario[]" id="id_usuario" value="'.$row["iduser"].'" ></td>
                                    ...
                                    <td class=" last"><a href="cadusuario.php?op=A&id='.$row['iduser'].'" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>
                                                    </td>';
