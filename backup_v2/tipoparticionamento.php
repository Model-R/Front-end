...
//	  require_once('classes/categoira.class.php');
	  ...
	  $FORM_ACTION = 'tipoparticionamento';
	...
	class MyPag extends Paginacao
	{
		function desenhacabeca($row)
		{
			 ...
			 <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Tipo Particionamento </th>
		...
		function desenha($row){
			$html = '<td class="a-center "><input type="checkbox" class="flat" name="id_tipoparticionamento[]" id="id_tipoparticionamento" value="'.$row["idtipoparticionamento"].'" ></td>
                                    <td class=" ">'.$row['algoritmo'].'</td>
                                    <td class=" last"><a href="cadtipoparticionamento.php?op=A&id='.$row['idtipoparticionamento'].'" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>
                                                    </td>';
...
$Paginacao = new MyPag();
$Paginacao->conn = $conn;
$sql = 'select * from tipoparticionamento where idtipoparticionamento = idtipoparticionamento
 ';

if ($tipofiltro=='NOME')
{
   $sql.= " and tipoparticionamento ilike '%".$valorfiltro."%'";	
}
...
{
   $sql.= " order by tipoparticionamento";	
}
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Consulta Tipo Particionamento <small>Tipo Particionamento cadastrados no sistema</small></h2>
                                ...
                                <span class="caret"></span>
                                         ...
                                         <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                            ...
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="cad<?php echo strtolower($FORM_ACTION);?>.php?op=I">Novo</a>
                                            </li>
								...
								<div class="form-group">
                                    ...
                                    <select id="cmboxtipofiltro" name="cmboxtipofiltro" class="form-control">
                                                    <option value="TIPOPARTICIONAMENTO" <?php if ($tipofiltro=='TIPOPARTICIONAMENTO') echo "selected";?>>Tipo Particionamento</option>
                                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="cmboxordenar" name="cmboxordenar" class="form-control">
                                                    <option value="TIPOPARTICIONAMENTO" <?php if ($ordenapor=='TIPOPARTICIONAMENTO') echo "selected";?>>Tipo Particionamento</option>
                                                    </select>
                                </div>
