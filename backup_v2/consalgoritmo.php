...
//	  require_once('classes/categoira.class.php');
	...
	class MyPag extends Paginacao
	{
		function desenhacabeca($row)
		{
			 ...
			 <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Algoritmo </th>
		...
		function desenha($row){
			$html = '<td class="a-center "><input type="checkbox" class="flat" name="id_algoritmo[]" id="id_algoritmo" value="'.$row["idalgorithm"].'" ></td>
                                    <td class=" ">'.$row['algorithm'].'</td>
                                    <td class=" last"><a href="cadalgoritmo.php?op=A&id='.$row['idalgorithm'].'" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a>
                                                    </td>';
...
$Paginacao = new MyPag();
$Paginacao->conn = $conn;
$sql = 'select * from modelr.algorithm where idalgorithm = idalgorithm
 ';

if ($tipofiltro=='NOME')
{
   $sql.= " and algorithm ilike '%".$valorfiltro."%'";	
}
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Consulta Algoritmo <small>Algoritmos cadastrados no sistema</small></h2>
								...
								<div class="form-group">
                                    ...
                                    <select id="cmboxtipofiltro" name="cmboxtipofiltro" class="form-control">
                                                    <option value="ALGORITMO" <?php if ($tipofiltro=='ALGORITMO') echo "selected";?>>Algoritmo</option>
                                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="cmboxordenar" name="cmboxordenar" class="form-control">
                                                    <option value="ALGORITMO" <?php if ($ordenapor=='ALGORITMO') echo "selected";?>>Algoritmo</option>
                                                    </select>
                                </div>
