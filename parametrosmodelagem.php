							...
							<div class="x_content">
							 ...
							 while ($row = pg_fetch_array($res))
							 {
								 ...
								 <?php if($row['idalgorithm'] == 1 || $row['idalgorithm'] == 4 || $row['idalgorithm'] == 7) {?>
									<input disabled type="checkbox" name="algoritmo[]" id="checkalgoritmo<?php echo $row['idalgorithm'];?>" value="<?php echo $row['idalgorithm'];?>" data-parsley-mincheck="2" required class="flat" /> <?php echo $row['algorithm'];?>
										<br />
								 <?php } else { ?>
