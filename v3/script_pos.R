...
# #salvando o raster .tif
 writeRaster(masked,
                    filename = paste("./temp/",expid,"/raster_crop-", expid, ".tif", sep=""), overwrite = T)
# #salvando o PNG de visualização
png(filename = paste("./temp/",expid,"/png_visual-", expid, ".png", sep=""), res = 300,
...
# #salvado o PNG do raster
 png(filename = paste("./temp/",expid,"/png_map-", expid, ".png", sep=""), bg = "transparent",
